...
def get_depth_frame(kinect_device_index):
    # return kinect_frame_convert.pretty_depth_cv(freenect.sync_get_depth(kinect_device_index)[0])
    return freenect.sync_get_depth(kinect_device_index)[0]
